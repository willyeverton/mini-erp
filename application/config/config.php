...
|
*/
$config['base_url'] = 'http://mini-erp.local/';
...
|
*/
$config['encryption_key'] = 'sua_chave_aleatoria_aqui';
...
$config['sess_save_path'] = APPPATH . 'cache/sessions'; // Caminho específico para sessões
...
$config['csrf_exclude_uris'] = array('webhook/order-status');
...
// Configuração para evitar problemas com headers already sent
$config['output_buffering'] = 4096;
